      ...
      <section className="pt-32 pb-14 px-6">
        <div className="max-w-[1160px] mx-auto text-center">
          ...
          <p className="text-lg text-[#C9CDD3] max-w-3xl mx-auto">
            ANVL is built by a small team focused on institutional-grade verification, risk controls, and workflow-aligned
            infrastructure for floorplan lenders.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {team.map((member) => (
              ...
              >
                ...
                <p className="text-[#C9CDD3] leading-relaxed">{member.credentials}</p>
              </div>
            ))}
          </div>
